...
while True:
    record = get_record()
    dx, rotate = 0, False
    sc.fill(pygame.Color('black'))  # Corrected: Fill the screen with black color
    game_sc.fill(pygame.Color('black'))  # Corrected: Fill the game screen with black color
    ...
    if anim_count > anim_limit:
        ...
        for i in range(4):
            ...
            if not check_borders():
                ...
                figure, color = deepcopy(next_figure), next_color
